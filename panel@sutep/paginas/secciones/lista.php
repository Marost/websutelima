...
// Data Gathering
$params['sql_query']                = "SELECT id,titulo,fecha_publicacion FROM ".$tabla_suf."_secciones ORDER BY fecha_publicacion DESC, id DESC";
...
<div id="content">
    <div class="contentTop">
        <span class="pageTitle"><span class="icon-screen"></span>Secciones</span>
    </div>
    ...
    <div class="wrapper">
        ...
        <!-- Media table sample -->
        <div class="widget">
            <div class="whead"><h6>Secciones</h6></div>
