...
// Data Gathering
$params['sql_query']                = "SELECT id,titulo FROM ".$tabla_suf."_enlace_interes ORDER BY id ASC";
...
<div id="content">
    <div class="contentTop">
        <span class="pageTitle"><span class="icon-screen"></span>Enlaces de Interes</span>
    </div>
    ...
    <div class="wrapper">
        ...
        <!-- Media table sample -->
        <div class="widget">
            <div class="whead"><h6>Enlaces de Interes</h6></div>
